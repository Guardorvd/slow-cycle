...
func _run_master_validation() -> void:
	...
	print("[TIER 1] Running 64 Core System Contracts (test_diagnostics.gd)...")
	var t1_ok: bool = _run_subprocess_tier(exe_path, "scripts/test/test_diagnostics.gd", 64, "Core Contracts")
	...
	print("==================================================================")
	print("  Tier 1 - Core System Contracts:            %s" % ("PASS (64/64)" if t1_ok else "FAIL"))
