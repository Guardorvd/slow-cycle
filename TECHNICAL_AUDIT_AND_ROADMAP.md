...
> Исторический аудит состояния Sprint 5. Актуальный статус проекта ведётся в `README.md` и `ROADMAP.md`; результаты тестов ниже не являются свежим запуском текущей ревизии.
